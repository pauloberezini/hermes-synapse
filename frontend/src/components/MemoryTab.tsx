    ...
    <div style={styles.tabWrapper}>
      <div style={styles.tabHeader}>
        <div>
          ...
          <p style={styles.tabSubtitle}>Adding notes and documents to SYNAPSE's long-term memory</p>
        </div>
      </div>
        ...
        <form onSubmit={handleIndexNote} style={styles.configForm} className="glass-panel">
          ...
          <div style={styles.formGroup}>
            ...
            <textarea 
              ...
              placeholder="Enter memory text, facts, or instructions for SYNAPSE to remember..." 
